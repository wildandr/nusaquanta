    ...
    <div className="py-10 overflow-hidden">
      ...
      >
        ...
        <div className=" flex flex-col items-center gap-4 mt-14 ">
          <section
            ref={skills}
            className="skill-set flex-nowrap flex gap-4 pl-[120rem] md:pl-[105rem] lg:pl-[100rem]  xl:pl-[80rem] 2xl:pl-[58rem] items-center justify-center"
          >
            {cardItems.map((_, index) => (
              <div
                key={index}
                className="cards w-[300px] h-[200px] lg:w-[350px] lg:h-[250px] p-1 rounded-[20px] duration-150 border-transparent hover:border-2 hover:border-primary flex justify-center items-end overflow-hidden"
              >
                ...
                <div className="hoverable bg-gradient-to-b from-transparent to-black to-[80%] flex justify-end items-center gap-2 fixed h-[60px] max-w-[292px] lg:max-w-[342px] lg:h-[80px] rounded-b-[20px] py-1 px-3">
                  ...
                  <p className="text-primary text-[10px] lg:text-[15px] font-bold z-20 w-full">
                    Interactive Custom Website for Lustrum KMTSL XI National
                    Event
                  </p>
                </div>
              </div>
            ...
            {cardItems.map((_, index) =>
              index === 6 ? (
                <Link
                  href="/"
                  key={index}
                  className="w-[300px] h-[200px] lg:w-[350px] lg:h-[250px] rounded-[20px] border-2 border-primary flex justify-center items-center"
                >
