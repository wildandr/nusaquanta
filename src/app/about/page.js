...
export const metadata = {
  title: 'About Us',
  description: 'Meet the people and thinking behind Nusa Quanta: a collaborative digital product studio bringing design, engineering, and data together.',
